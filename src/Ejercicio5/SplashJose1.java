 ...
 * @author PC
 */
public class SplashJose1 extends javax.swing.JFrame {

    /**
     * Creates new form SplashJose1
     */
    public SplashJose1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashJose1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       SplashJose1 sp = new SplashJose1();
       sp.setVisible(true);
        Calculadora cal= new Calculadora();
        sp.barracarga.setForeground(blue);//CAMBIAR EL COLOR DE LA BARRA
        try {
            for(int i=0;i<=100;i++){
